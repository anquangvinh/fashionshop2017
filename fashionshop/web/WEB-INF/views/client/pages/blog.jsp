...
<div class="blog-content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8 blog-content">
                <article class="blogpost">
                    ...
                    <div class="post-media">
                        <div class="blog-slider">
                            ...
                            <div class="item">						
                                <img src="" class="img-responsive" alt="">
                                <!--                                <img src="assets/images/blog/1/a2size.jpg" class="img-responsive" alt=""/>-->
                ...
                <c:forEach items="${blogListClient}" var="blogclient" begin="0" end="30" varStatus="no">
                    <div class="col-md-9 col-sm-8 blog-content">
                        <article class="blogpost">
    ...
    <!--    <script src="assets/admin/vendor/datatables/js/jquery.dataTables.min.js"/>
        <script src="assets/admin/vendor/datatables-plugins/dataTables.bootstrap.min.js"/>
        <script src="assets/admin/vendor/datatables-responsive/dataTables.responsive.js"/>-->