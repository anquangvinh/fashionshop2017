    ...
    <div class="container">
        <div class="row">
                ...
                <div class="side-widget space50">
                    ...
                    <ul class="list-unstyled cat-list">
                        <c:forEach items="${blogCateListClient}" var="blogcateclient">
                            <li> <a href="blog/">${blogcateclient.blogCateName}</a></li>
                            </c:forEach>
                    </ul>
                </div>
                <div class="side-widget space50">
                    ...
                    <ul class="list-unstyled popular-post">
                        ...
                        <c:forEach items="${blogListClient}" var="blogpopularclient" begin="0" end="2" varStatus="no">
                            <li>
                                <div class="popular-img">
                                    <a href="#"> <img src="assets/images/blog/1/3.jpg" class="img-responsive" alt=""></a>
                                </div>
                                <div class="popular-desc">
                                    <h5> <a href="#">${blogpopularclient.blogTitle}</a></h5>
                                    <span>By Admin</span>
                                </div>
                            </li>
                        </c:forEach>
            ...
            <div class="post-media">
                ...
                -->                                                            </div>
                <c:forEach items="${blogListClient}" var="blogclient" begin="0" end="3" varStatus="no">
                <div class="col-md-9 col-sm-8 blog-content">
                    ...
                    <article class="blogpost">
                        ...
                        <div class="quote-meta">
                            <div class="post-meta">
                                <span><a href="#"><i class="fa fa-calendar"></i>${blogclient.postedDate}</a></span>
                                <span><a href="#"><i class="fa fa-user"></i> ${blogclient.user.userID}</a></span>
                                <span><i class="fa fa-folder"></i><a href="">${blogcateclient.blogCateName}</a></span>
                            </div>
