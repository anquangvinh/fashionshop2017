                                    ...
                                    <div class="">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active text-center" id="home">
                                                ...
                                                <form action="user/login.html" method="post" class="form-login fs-login-modal" id="fs-form-login-user"> 
                                                    ...
                                                    <ul class="form-list row">
                                                        ...
                                                        <li class="col-md-6 col-sm-12">                                                
                                                            <input id="fs-check-remember" class="input-chkbox" type="checkbox">
...
<!--                                                        <li class="col-md-6 col-sm-12 pwd text-right">
                                            ...
                                            <div role="tabpanel" class="tab-pane" id="profile">
                                                ...
                                                <div class="clearfix" ></div>
                                                <form class="form-login" method="POST" id="fs-form-create-user">    
                                                    <ul class="form-list row">
                                                        ...
                                                        <li class="col-md-6 col-sm-12">
                                                            ...
                                                            <div class="fs-password-create">
                                                                <input type="password" id="fs-create-password password" name="password" class="input-text"  />
                                                        ...
                                                        <li class="col-md-6 col-sm-12">
                                                            ...
                                                            <div class="fs-repassword-create">
                                                                <input type="password" id="fs-create-repassword Repassword" name="Repassword" class="input-text" />
                                                    ...
                                                    <div class="buttons-set text-center">
                                                        <button class="btn-black btn-custom fs-button-create-user" type="submit"><span>Create Account</span></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
